...
export const deOverrides: Record<string, string> = {
        ...
        'tutorial.capture': '1. Erfassen (Posteingang)',
        ...
        'tutorial.clarify': '2. Abklären & Organisieren',
        ...
        'process.delegateFollowUpLabel': 'Weriterverfolgungs-Termin (Optional)',
        ...
        'agenda.starting': 'Beginn / Asuführbar',
        ...
        'search.saveSearch': 'Diese Suche speichern',
        'search.saveSearchPrompt': 'Diese Suche benennen',
        ...
        'settings.calendarSystemDeniedHint': 'Kalenderzugriff wurde abgelehnt. Enable Mindwtr in macOS System Einstellungen > Privacy & Security > Kalenders.',
