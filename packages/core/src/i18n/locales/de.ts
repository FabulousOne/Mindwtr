...
export const deOverrides: Record<string, string> = {
        ...
        'settings.aiThinkingEnable': 'Erweiteretes Denken aktivieren',
        ...
        'search.includeCompleted': 'Erledigte and archivierte Aufgaben einschließen',
        ...
        'settings.downloadAURHint': 'Arch erkannt: Aktualisierung über Unter Linux kann Mindwtr Aktualisierungen nicht automatisch installieren. Installieren Sie das Programm nach dem Herunterladen über Ihren Paketmanager (z. B. `yay -S mindwtr` oder `paru -S mindwtr`) oder das heruntergeladene Paket.AUR',
