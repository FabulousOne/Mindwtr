export type Language = 'en' | 'zh' | 'es' | 'hi' | 'ar' | 'de' | 'ru' | 'ja' | 'fr' | 'pt' | 'ko' | 'it' | 'tr';
...
const esOverrides: Record<string, string> = {
        ...
        'settings.systemDesc': 'Seguir la preferencia del sistema',
        ...
        'settings.logMissing': 'Aún no hay archivo de registro. Activa el registro y reproduce el problema primero.',
        ...
        'settings.followDevice': 'Seguir la apariencia del dispositivo',
        ...
        'settings.webdavHint': 'Usa una URL completa a tu JSON de sincronización.',
        ...
        'settings.notificationsDesc': 'Habilita recordatorios para tareas con fechas de inicio o vencimiento.',
        ...
        'settings.aiCopilotHint': 'Usado para sugerencias rápidas.',
        ...
        'settings.autoArchiveDays': 'Días de autoarchivado',
        'settings.autoArchiveNever': 'Nunca (mantener en Hecho)',
        'settings.timeEstimatePresets': 'Preajustes de tiempo',
        'settings.timeEstimatePresetsDesc': 'Configura estimaciones rápidas para bloquear tiempo.',
        ...
        'settings.featuresDesc': 'Señales opcionales que puedes activar cuando las necesites.',
        ...
        'settings.featureTimeEstimatesDesc': 'Añade estimaciones rápidas para bloqueos de tiempo.',
        ...
        'settings.weeklyReviewDesc': 'Recordatorio semanal en la hora elegida.',
        ...
        'settings.cloudHint': 'Usa tu endpoint cloud (p. ej., https://example.com/v1/data).',
...
const deOverrides: Record<string, string> = {
        ...
        'settings.cloudSave': 'Cloud speichern',
        'settings.cloudHint': 'Verwenden Sie Ihren Cloud-Endpunkt (z. B. https://example.com/v1/data).',
...
const jaOverrides: Record<string, string> = {
        ...
        'settings.syncBackendWebdav': 'WebDAV',
        'settings.syncBackendCloud': 'クラウド',
        'settings.webdavUrl': 'WebDAV URL',
        ...
        'settings.cloudUrl': 'クラウド URL',
        'settings.cloudToken': 'アクセストークン',
        'settings.cloudSave': 'クラウドを保存',
        'settings.cloudHint': 'クラウドのエンドポイントを使用してください（例: https://example.com/v1/data）。',
